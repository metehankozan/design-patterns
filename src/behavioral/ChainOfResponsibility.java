    ...
    class Officer extends Approver {
        ...
        boolean approveLoan(int amount) {
            if (amount < 100) {
                ...
                System.out.println("Amount is grater than officer can approve. Passing to chief");
    ...
    class Manager extends Approver {
        ...
        boolean approveLoan(int amount) {
            if (amount < 500) {
                ...
                System.out.println("Amount is grater than manager can approve. Passing to chief");
                return chief.approveLoan(amount);
            }
            return false;
        }
